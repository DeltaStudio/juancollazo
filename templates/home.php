				...
				if ( $home_portfolio_query->posts ) { ?>
					<div id="home-portfolio" class="clr">
						<?php if( get_theme_mod( 'wpex_home_portfolio_title', 'wpex' ) ) { ?>
							<h2 class="heading"><?php echo get_theme_mod( 'wpex_home_portfolio_title', __( 'Últimos trabajos', 'wpex' ) ); ?></h2>
						<?php } ?>
						...
						<div id="home-portfolio-view-all" class="clr">
							<a href="<?php echo get_post_type_archive_link( 'portfolio' ); ?>" title="<?php _e( 'Browse all', 'wpex'); ?>"><?php _e( 'Ver todos', 'wpex'); ?></a>
